...
<div class="container">
    <div class="page-header">
        ...
        <div class="row"> 
            <div class="blog-description  col-xs-12 col-md-5 col-lg-7"><?= $categorie->titre; ?></div>
                    ...
                    <ul class="pagination">
                        ...
                        for ($i = 1 ; $i <= $nbrOfPages ; $i++)
                        {
                            if(isset($page)){
                                if($page == $i){
                        ?>
                        <li class="active"><a href="?p=posts.category&id=<?= $categorie->id?>&page=<?= $i ?>&orderBy=<?= $orderSelected ?>"><?= $i ?><span class="sr-only">(current)</span></a></li>
                   
                        <?php
                                }else{
                        ?>
                        <li><a href="?p=posts.category&id=<?= $categorie->id?>&page=<?= $i ?>&orderBy=<?= $orderSelected ?>"><?= $i ?></a></li>
