            ...
            <div class="tab-content">
                ...
                <div class="tab-pane" id="add-comment-disabled">
                    <div class="alert alert-info alert-dismissible" role="alert">
                      ...
                      <strong>Hey!</strong> Si vous avez déjà un compte <a href="?p=users.login&Id=" <?php $post->getId(); ?>  class="alert-link">Connectez vous</a> d'abord pour laisser un commentaire.
                    </div>
